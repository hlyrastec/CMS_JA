...
const financialController = {
	...
	incomeFilter: async (req, res) => {
		...
		if(req.body.income_date){
			params.push("date");
			values.push(lib.convertDate(req.body.income_date));
		};
		...
		Financial.incomeFilter(params, values)
			.then(incomes => {
				res.send(incomes);
			})
			.catch(err => {
	...
	outcomeFilter: async (req, res) => {
		...
		if(req.body.outcome_date){
			params.push("date");
			values.push(lib.convertDate(req.body.outcome_date));
		};
		...
		Financial.outcomeFilter(params, values)
			.then(incomes => {
				res.send(incomes);
			})
			.catch(err => {
